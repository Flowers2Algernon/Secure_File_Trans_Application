    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encryption_algorithm', models.CharField(blank=True, default='AES-256-GCM', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download_final_datetime', models.DateTimeField(blank=True, null=True)),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True)),
                ('user_agent', models.TextField(blank=True, null=True)),
                ('encrptedFile', models.ForeignKey(db_column='file_id', on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='transfer.encrptedfile')),
            ],
        ),
        migrations.CreateModel(
            name='KeyPair',
